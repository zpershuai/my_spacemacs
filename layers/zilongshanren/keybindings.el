...
(spacemacs/set-leader-keys "fz" 'recentf-cleanup)
...
;;zpershuai start
(spacemacs/set-leader-keys "bu" 'imenu-list)
(spacemacs/set-leader-keys "yd" 'ahs-forward-definition)
(spacemacs/set-leader-keys "ya" 'ggtags-grep)
(spacemacs/set-leader-keys "yf" 'ggtags-view-search-history)
